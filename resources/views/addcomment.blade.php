    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <div class="w-full bg-white rounded-lg shadow  md:mt-0 sm:max-w-md xl:p-0 ">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="/postcomment" method="post" enctype="multipart/form-data">
                    @csrf

                    <input type="text" name="user_id" id="user_id" class="hidden" placeholder="This is my post"
                        value="{{ Auth::user()->id }}">

                    <input type="text" name="tweet_id" id="tweet_id" class="hidden" placeholder="This is my post"
                        value="{{ $item->id }}">
                    ...
                    <div>
                        ...
                        <input type="text" name="comment" id="comment"
                            ...
                            placeholder="This is my comment" required="">
                    </div>
                    <div>
                        <label for="tags" class="block mb-2 text-sm font-medium text-gray-900 ">Tags</label>
                        <input type="text" name="tags" id="tags"
                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 "
                            placeholder="Alphabet, Numbers (Divide using comma)" required="">
                    </div>
                    <div>
                    ...
                    <button type="submit"
                        class="w-full text-white bg-bluetwitar focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center">Post
                        Comment</button>
