    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <div class="w-full bg-white rounded-lg shadow  md:mt-0 sm:max-w-md xl:p-0 ">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="/updatetweets/{{ $data->id }}" method="post"
                    ...
                    <div>
                        ...
                        <input type="text" name="tweets" id="tweets"
                            ...
                            placeholder="This is my post" value="{{ $data->tweets }}" required>
                    </div>

                    <div>
                        <label for="tags" class="block mb-2 text-sm font-medium text-gray-900 ">Caption</label>
